...
export interface PrinterEditor {
  ...
  addClock: () => void;
  addWifi: () => void;
  setShared: (p: Partial<Pick<PrinterConfig, "clockTimezone" | "clock24h" | "wifiLevel" | "qrTimeoutSeconds" | "qrShape" | "qrFg" | "qrBg" | "qrCornerRadius" | "qrShadowMode" | "qrShadowStrength" | "qrShadowColor">>) => void;
...
export function usePrinterEditor({
  ...
  const setShared = (p: Partial<Pick<PrinterConfig, "clockTimezone" | "clock24h" | "wifiLevel" | "qrTimeoutSeconds" | "qrShape" | "qrFg" | "qrBg" | "qrCornerRadius" | "qrShadowMode" | "qrShadowStrength" | "qrShadowColor">>) =>
    onChange({ ...config, ...p });
