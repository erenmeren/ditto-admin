    ...
    case "processing":
      ...
      return {
        objects: [
          ...
          obj({ id: "text-caption", type: "text", x: 0.15, y: 0.56, w: 0.7, h: 0.08, z: 1, text: "Getting things ready…", fontSize: 26, align: "center" }),
          obj({ id: "text-sub", type: "text", x: 0.2, y: 0.66, w: 0.6, h: 0.06, z: 2, text: "This only takes a moment", fontSize: 16, align: "center" }),
        ],
      };
    case "qr":
      // From the QR screen preview (printer-preview.tsx): heading + qr + caption + countdown.
      return {
        objects: [
          obj({ id: "text-heading", type: "text", x: 0.1, y: 0.2, w: 0.8, h: 0.07, z: 1, text: "Scan to continue", fontSize: 24, align: "center" }),
    ...
    case "sent":
      ...
      return {
        objects: [
          ...
          obj({ id: "text-title", type: "text", x: 0.1, y: 0.48, w: 0.8, h: 0.08, z: 1, text: "You're all set", fontSize: 26, align: "center" }),
    ...
    case "error":
      ...
      return {
        objects: [
          ...
          obj({ id: "text-title", type: "text", x: 0.1, y: 0.44, w: 0.8, h: 0.08, z: 1, text: "Something went wrong", fontSize: 24, align: "center" }),
          obj({ id: "text-sub", type: "text", x: 0.15, y: 0.54, w: 0.7, h: 0.06, z: 2, text: "The device is offline right now.", fontSize: 16, align: "center" }),
          obj({ id: "text-pill", type: "text", x: 0.15, y: 0.72, w: 0.7, h: 0.08, z: 3, text: "Please ask a team member for help", fontSize: 15, align: "center" }),
        ],
      };
    case "paused":
